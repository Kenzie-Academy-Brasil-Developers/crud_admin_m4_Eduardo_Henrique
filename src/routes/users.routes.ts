...
userRoutes.patch("/:id", ensureIdExists, ensureToken, checkPermission,ensureBodyIsValid(updateUserSchema), ensureEmailExists, updateUser);

userRoutes.put("/:id/recover", ensureBodyIsValid(updateUserSchema), ensureToken, ensureAdminIsTrue, ensureUserAlreadyActive, reactiveUser);

userRoutes.delete("/:id", ensureToken, ensureIdExists, checkPermission, deleteUser);
